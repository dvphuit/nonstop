...
class GetVideoDetailUseCase(private val remote: RemoteRepo) :
    SuspendUseCase<GetVideoDetailUseCase.Params, YoutubeVideoResponse>(Dispatchers.IO) {
    ...
    override suspend fun execute(parameters: Params): YoutubeVideoResponse {
        return remote.getVideo(parameters.videoId)
    }
